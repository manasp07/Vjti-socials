    ...
    <WidgetWrapper>
      ...
      <Box p="1rem 0">
        <Box display="flex" alignItems="center" gap="1rem" mb="0.5rem">
          ...
          <Typography color={medium}>{hometown}</Typography>
        </Box>
        <Box display="flex" alignItems="center" gap="1rem" mb="0.5rem">
          <Typography fontSize="large" sx={{ color: main }}>Branch:</Typography>
          <Typography color={medium}>{branch}</Typography>
        </Box>
        <Box display="flex" alignItems="center" gap="1rem">
          <Typography fontSize="large" sx={{ color: main }}>Year:</Typography>
